...
@section('title_pages', 'Laporan Retur Penjualan')
  ...
  <div class="content">
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header card-header-primary">
              <h4 class="card-title">Laporan Retur Penjualan</h4>              
            </div>
            <div class="card-body">
							<style>
								@media print{
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			$('#reportTransaction').load("/data_report_retur_penjualan");
    ...
    function viewReport(){
      ...
      $('#reportTransaction').load("/data_report_retur_penjualan_custom/"+tgl+"/"+mounth+"/"+thn);
