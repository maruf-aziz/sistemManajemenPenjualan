      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
							<form action="/retur_pembelian" method="POST">
                @csrf
                <div class="form-group">
                  <label for="">Supplier</label>
                  <br>
                  <input type="text" class="input-css" value="{{ $purchases->name }}" disabled>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <br>
                  <input type="hidden" name="id_transaksi" value="{{ $purchases->id_purchase }}">
